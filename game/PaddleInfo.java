...
public class PaddleInfo extends JPanel {
     ...
     * empty constructor
     */
    public PaddleInfo(int position)
    {
     ...
     */
    public PaddleInfo(Player paddleIn, String imgadd) {
        paddle = paddleIn;
    ...
    public void setPlayer(Player paddleIn, String imgadd)
    {
        ...
        score = 0;
        scoreLabel.setText("level " + String.valueOf(score));
...
//        {
//            case 1:
//                wIcon.setIcon(new ImageIcon(this.getClass().getResource("../images/a.png")));
//                break;
//            case 2:
//                wIcon.setIcon(new ImageIcon(this.getClass().getResource("../images/b.png")));
//                break;
//            case 3:
//                wIcon.setIcon(new ImageIcon(this.getClass().getResource("../images/c.png")));
//                break;
//            case 4:
//                wIcon.setIcon(new ImageIcon(this.getClass().getResource("../images/d.png")));
//                break;
//        }
